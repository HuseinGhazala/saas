...
-- يُنفَّذ تلقائياً مع: supabase db push أو supabase migration up
...
COMMENT ON FUNCTION public.settings_enforce_plan_permissions() IS 'يفرض قيود الباقة المجانية على data عند حفظ settings';
